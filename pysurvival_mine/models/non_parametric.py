...
from pysurvival_mine.models._non_parametric import _KaplanMeierModel
from pysurvival_mine.models._non_parametric import _KernelModel
    ...
    * kernel: str (default='normal')
    ...
    def __repr__(self):
        ...
        self.name = self.name.format(
            self.__class__.__name__, self.bandwidth, self.kernel
        )
        return self.name
