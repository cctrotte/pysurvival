...
if __name__ == "__main__":
    ...
    features = list(S_baseline[S_baseline.p_values < 0.05].variables) # 0.1
    ...
    # for death to avoid errors
        eval_times= [0.1, 0.25931506849315067, 0.6552054794520548, 1.5, 2.636849315068494, 4.069452054794517, 5.115260273972603, 6.753890410958904, 8.585342465753424, 10] 
    ...
    with open(save_path + "cv_results_26_01_all_death.pickle", "wb") as f:
